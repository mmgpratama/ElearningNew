...
<head>
	...
	<title>Login | SMP Negeri 1 SARMI -- E-LEARNING</title>
...
<body>
							...
							<div class="card-body">
								<form method="POST" action="" class="needs-validation" novalidate="">
									<div class="form-group">
										<label for="username">N I S</label>
										<input id="username" type="text" class="form-control" name="username" tabindex="" required autofocus placeholder="Username">
									...
									<div class="form-group">
										<button name="login_pelajar" type="submit" class="btn btn-primary btn-lg btn-block" tabindex="3">
											Login
										</button>
									</div>
									...
									<div class="form-group">
										<a href="login_petugas.php" name="login_guru" class="btn btn-warning btn-lg btn-block" tabindex="3">
											Login Guru
										</a> 
									</div>
								</form>
  ...
  if (isset($_POST['login_pelajar'])) {
  	$hasil = $pelajar->login($_POST['username'], $_POST['password']);
