...
<head>
  ...
  <title>E-LEARNING SMPN1 SARMI | Dashboard</title>
  ...
  <div class="page-wrapper wrapper">
    ...
    <aside class="navbar-side main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Administator</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block"><?php echo $data_admin['nama_admin'] ?></a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="?kelas" class="nav-link" style="background-color: #18211a;">
                  <i class="fas fa-people-arrows nav-icon" style="color: #dae6fb;"></i>
                  <p>Data Kelas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="?pelajar" class="nav-link" style="background-color: #18211a;">
                  <i class="fas fa-users nav-icon" style="color: #dae6fb;"></i>
                  <p>Data Pelajar</p>
                </a>
              </li>
              <li class="nav-item">
...
<!--       <li class="nav-item">
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <a href="?anggota=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
              <p>Laporan Anggota</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?buku=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
              <p>Laporan Buku</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?penerbit=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
              <p>Laporan Penerbit</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?peminjaman=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
              <p>Laporan Peminjaman</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?pengembalian=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
              <p>Laporan Pengembalian</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="?kehilangan=laporan" class="nav-link" style="background-color: #300c0c;">
              <i class="far fa-circle nav-icon"></i>
