...
elseif (isset($_GET['course']) && $_GET['course']=='mycourse') {
  include 'course/mycourse.php';
}
...
elseif (isset($_GET['detailtugas']) && $_GET['detailtugas']=='ubah') {
  include 'materi/tugas/ubah.php';
}
elseif (isset($_GET['detailtugas']) && $_GET['detailtugas']=='hapus') {
  include 'materi/tugas/hapus.php';
}
elseif (isset($_GET['detailtugas']) && $_GET['detailtugas']=='tambah') {
  include 'materi/tugas/tambah.php';
}
