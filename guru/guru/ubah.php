<?php
$id = $_GET['id'];
$data_guru = $guru->ambil_guru($id);
?>

<br>
<h1 class="text-center" style="font-weight: bold">PERUBAHAN DATA GURU</h1>
<br>
	...
	<div class="card-body">
		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nip" placeholder="NIP : 0000-000-00-0" required="" value="<?php echo $data_guru['nip'] ?>">
			</div>
...
if (isset($_POST['simpan']))
{
	...
	if($_POST['nip']!=$data_guru['nip'])
	{
		if (in_array($_POST['nip'], $nip)) {
			...
			$hasil = $guru->ubah($_POST['nip'], $_POST['nama'], $_POST['alamat'], $_POST['jk'], $id);
